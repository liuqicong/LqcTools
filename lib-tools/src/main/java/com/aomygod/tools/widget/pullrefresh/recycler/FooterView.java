...
public class FooterView extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        btFooter = (RelativeLayout) foot.findViewById(R.id.list_getmore_foot);
        progFooter = (ImageView) foot.findViewById(R.id.list_getmore_progress);
        tvFooter = (TextView) foot.findViewById(R.id.tv_list_getmore_info);
