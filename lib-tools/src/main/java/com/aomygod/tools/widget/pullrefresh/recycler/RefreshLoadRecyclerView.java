...
//                        if(footEnable && adapter instanceof RefreshLoadRecyclerAdapter){
//                            RefreshLoadRecyclerAdapter recyclerAdapter= (RefreshLoadRecyclerAdapter) adapter;
//                            recyclerAdapter.setFooterView(mFooterLayout);
//                            recyclerAdapter.showWait();
//                        }
//
//                    }
//                }
...
//                    //changingHeaderViewTopMargin(-dy);
//
//
//                }
//            }
...
//        });
    ...
    public void onHeaderRefreshComplete() {
        if (mHeaderState != State.PULL_TO_REFRESH) {
            mHeaderState = State.PULL_TO_REFRESH;
            LayoutParams params = (LayoutParams) mHeaderLayout.getLayoutParams();
            @SuppressLint("ObjectAnimatorBinding") ObjectAnimator objectAnimator = ObjectAnimator.ofInt(mHeaderLayout, "xyz", params.topMargin, -mHeaderViewHeight).setDuration(500);
