...
public final class HeaderLayout extends LinearLayout {
	...
	private void initRightTextView() {
		...
		mRightTextView = (TextView) mRightImageTextView.findViewById(R.id.ib_titlebar_right);
		mRightImageView = (ImageView) mRightImageTextView.findViewById(R.id.web_refresh_btn);
	}
