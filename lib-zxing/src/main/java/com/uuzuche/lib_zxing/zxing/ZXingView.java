...
import com.uuzuche.lib_zxing.core.BGAQRCodeUtil;
import com.uuzuche.lib_zxing.core.BarcodeType;
import com.uuzuche.lib_zxing.core.QRCodeView;
import com.uuzuche.lib_zxing.core.ScanResult;
...
public class ZXingView extends QRCodeView {
    ...
    protected ScanResult processBitmapData(Bitmap bitmap) {
        ...
        if (result.getBarcodeFormat() == BarcodeFormat.QR_CODE){
            return new ScanResult(result.getText(),1);
        } else {
            return new ScanResult(result.getText(),0);
        }
    }
    ...
    protected ScanResult processData(byte[] data, int width, int height, boolean isRetry) {
        ...
        if (rawResult.getBarcodeFormat() == BarcodeFormat.QR_CODE){
            return new ScanResult(rawResult.getText(),1);
        } else {
            return new ScanResult(rawResult.getText(),0);
        }
    }
